		...
		this.each(function(){
			...
			if($t.find('th[data-content]').length > 0) {
				...
				$t.find('th[data-content]').each(function(){
						...
						if( $(this).attr('data-content').substr(0,4) == 'null' ) {
							...
							if(typeof $(this).attr('data-table') == 'undefined') {
								...
								if(typeof $(this).attr('data-alias') == 'undefined') {
									...
									$(this).attr('data-alias', $t.attr('data-table').replace(' ','_') + '_' + $(this).attr('data-alias'));
								}
								$(this).removeAttr('data-content');
							} else {
					...
					if(typeof $(this).attr('data-filter') == 'undefined' && typeof $(this).attr('data-alias') != 'undefined' && $(this).attr('data-alias').substr(0,4) != 'null' && $(this).attr('data-field') != $t.attr('data-table') + '.id') {
					...
					if(typeof $(this).attr('data-sort') == 'undefined' && typeof $(this).attr('data-alias') != 'undefined' && $(this).attr('data-alias').substr(0,4) != 'null' && $(this).attr('data-field') != $t.attr('data-table') + '.id') {
												...
												if(typeof res.data[i][$(this).attr('data-alias')] != 'undefined') {
													...
													if(e_name[1] == 'id' && a_name.substr(a_name.length - 2) == 'id') {
														...
														if(string && typeof $(this).attr('data-badge') != 'undefined') {
															...
															if(badge_color) {
																if(badge_color == 'info' || badge_color == 'primary' || badge_color == 'success' || badge_color == 'warning' || badge_color == 'danger') {
																	string = '<span class="icon-badge bg-'+badge_color+'"></span> ' + string;
																} else {
