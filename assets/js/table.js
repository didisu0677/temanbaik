...
(function($){
	$.fn.serverside = function(options) {
		...
		this.each(function(){
			var $t = $(this);
			var tableName = Base64.decode($t.attr('data-key'));
			if($t.find('th[data-content]').length > 0) {
				...
				$t.find('th[data-content]').each(function(){
					...
					if(typeof $(this).attr('data-content') != 'undefined') {
						if( $(this).attr('data-content').substr(0,4) == 'null' ) {
							$(this).attr('data-field', $(this).attr('data-content'));
							if(typeof $(this).attr('data-alias') == 'undefined') {
								$(this).attr('data-alias', $(this).attr('data-content'));
							}
							$(this).removeAttr('data-content');
						} else {
							if(typeof $(this).attr('data-key') == 'undefined') {
								$(this).attr('data-field', tableName + '.' + $(this).attr('data-content'));
								if(typeof $(this).attr('data-alias') == 'undefined') {
									$(this).attr('data-alias', tableName.replace(' ','_') + '_' + $(this).attr('data-content'));
								} else {
									$(this).attr('data-alias', tableName.replace(' ','_') + '_' + $(this).attr('data-alias'));
								}
								$(this).removeAttr('data-content');
							} else {
								var tblName = Base64.decode($(this).attr('data-key'));
								$(this).attr('data-field', tblName + '.' + $(this).attr('data-content'));
								$(this).attr('data-alias', tblName.replace(' ','_') + '_' + $(this).attr('data-content'));
								$(this).removeAttr('data-content').removeAttr('data-key');
							}
						}
					}
					if(typeof $(this).attr('data-filter') == 'undefined' && typeof $(this).attr('data-alias') != 'undefined' && $(this).attr('data-alias').substr(0,4) != 'null' && $(this).attr('data-field') != tableName + '.id') {
						...
						if($(this).attr('data-field') == tableName + '.id' && $(this).find('[type="checkbox"]').length == 1) {
					...
					if(typeof $(this).attr('data-sort') == 'undefined' && typeof $(this).attr('data-alias') != 'undefined' && $(this).attr('data-alias').substr(0,4) != 'null' && $(this).attr('data-field') != tableName + '.id') {
		...
		function getData(e,refresh,refix) {
			...
			e.find('[data-field]').each(function(i,d){
				if($(this).attr('data-field').substr(0,4) != 'null') {
					field.push(Base64.encode($(this).attr('data-field')));
					alias.push(Base64.encode($(this).attr('data-alias')));
				}
			});
			if(typeof $('[data-serverside]').attr('data-additional-select') != 'undefined') {
				...
				$.each(s_additional,function(e_add,d_add){
					if(d_add.indexOf('.') == -1) {
						field.push(Base64.encode(Base64.decode($('[data-serverside]').attr('data-key'))+'.'+d_add));
						alias.push(Base64.encode(Base64.decode($('[data-serverside]').attr('data-key'))+'_'+d_add));
					} else {
						field.push(Base64.decode(d_add));
						alias.push(Base64.decode(d_add.replace('.','_')));
					}
				});
			}
			e.find('[data-filter]').each(function(i,d){
				...
				if(v != '') {
					filter.push(Base64.encode($(this).attr('data-filter')));
					filter_v.push(Base64.encode(v));
				}
			});
			var serialize = {};
			...
			serialize['table']		= e.attr('data-key');
			...
			serialize['order_by']	= Base64.encode(order_by);
										...
										e.children('thead').children('tr').first().children().each(function(){
											...
											if(typeof $(this).attr('data-alias') != 'undefined') {
												if(typeof res.data[i][$(this).attr('data-alias')] != 'undefined') {
													...
													var a_name	= $(this).attr('data-alias');
													...
													if(e_name[1] == 'id' && a_name.substr(a_name.length - 2) == 'id') {
														if(e.children('thead').children('tr').last().find('input[type="checkbox"]').length == 1) {
															konten += '<td'+cls+' data-rowid="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'">';
															konten += '<div class="custom-checkbox custom-control">';
															konten += '<input class="custom-control-input" type="checkbox" id="chk-td-'+i+'" value="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'">';
															...
															if(i_show && typeof $(this).attr('data-link') != 'undefined') {
																...
																var encode_id = hashids_link.encode(res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id'], Math.floor(Math.random() * (9999 - 1000 + 1)) + 100 );
															...
															konten += '<td'+cls+' data-rowid="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'">'+i_show+'</td>';
														}
													} else {
														...
														if(typeof $(this).attr('data-default') != 'undefined' && (string == '' || string == '0')) {
														...
														if(string && typeof $(this).attr('data-icon') != 'undefined') {
															...
															if(typeof _icon[1] != 'undefined') {
																...
																if(_field.length == 1) {
																	field_icon = Base64.decode($('[data-serverside]').attr('data-key')) + '_' + _icon[1];
																} else {
														...
														if(string && typeof $(this).attr('data-link') != 'undefined') {
															...
															if(spl_link.length == 1) {
																string = '<a href="javascript:;" class="'+link_col+'" data-id="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'" data-value="'+str_label+'">'+string+'</a>';
															}  else {
																if(link_col.substr(link_col.length - 1) != '/') {
																	link_col += '/';
																}
												...
												if(typeof $(this).attr('data-action') == 'undefined') {
													...
													var encode_id = hashids.encode(res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id'], Math.floor(Math.random() * (9999 - 1000 + 1)) + 100 );
															...
															if(d_res.length == 5) {
																...
																if(show_button) {
																	if(d_res[1].split('/').length > 1) {
																		...
																		konten += '<button type="button" data-key="'+d_res[3]+'" class="btn '+d_res[0]+' '+act+'" data-id="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'" title="'+icon.replace(/(<([^>]+)>)/ig,"").trim('')+'">'+icon+'</button>'  + "\n";
																	}
													...
													if(res.accessEdit == '1' || res.accessDelete == '1' || res.accessView == '1') {
														...
														if(res.accessView == '1') {
															...
															if(res.linkView == '') {
																konten += '<button type="button" class="btn btn-info btn-act-view" data-key="view" data-id="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'" title="'+lang.detil+'"><i class="fa-search"></i></button>' + "\n";
															} else {
														...
														if(res.accessEdit == '1' && (typeof $('[data-serverside] th[data-action]').attr('data-edit') == 'undefined' || (typeof $('[data-serverside] th[data-action]').attr('data-edit') !== 'undefined' && typeof $('[data-serverside] th[data-action]').attr('data-edit') == 'true')) ) {
															...
															if(res.linkEdit == '') {
																konten += '<button type="button" class="btn btn-warning btn-input" data-key="edit" data-id="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'" title="'+lang.ubah+'"><i class="fa-edit"></i></button>' + "\n";
															} else {
														...
														if(res.accessDelete == '1') {
															...
															if(res.linkDelete == '') {
																konten += '<button type="button" class="btn btn-danger btn-delete" data-key="delete" data-id="'+res.data[i][Base64.decode($('[data-serverside]').attr('data-key')) + '_id']+'" title="'+lang.hapus+'"><i class="fa-trash-alt"></i></button>';
															} else {
...
function cek_autocode(callback) {
	var cur_table = Base64.decode($('[data-key]').first().attr('data-key'));
	$.ajax({
