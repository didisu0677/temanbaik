  ...
  $.extend(EmojiPicker.prototype, {
    ...
    addPickerIcon: function() {
      ...
      if (this.settings.button) {
        ...
        var iconHeight = elementHeight > MAX_ICON_HEIGHT ?
          MAX_ICON_HEIGHT :
          elementHeight;
        if(this.settings.pickerHeight > 0) iconHeight = this.settings.pickerHeight;
    ...
    updatePosition: function() {
      ...
      */
      ...
      var offetCustomTop = this.settings.pickerHeight > 0 ? this.settings.pickerHeight : MAX_ICON_HEIGHT;
      var customTop = elOffset.top + offetCustomTop;
      elOffset.top += this.$el.outerHeight();

      // Step 3
      var diffOffset = {
        // top: (elOffset.top - parentOffset.top), // asli
        top: (customTop - parentOffset.top),
    ...
    clickOutside: function(e) {
      if ( this.active && !$(e.target).hasClass('emojiPickerIcon') ) {
        this.hide();
      }
    },
