        ...
        function initialize() {
            ...
            if (shouldReplace) {
                ...
                addOn.width(boundElement.outerHeight() + 'px')
                     .height(boundElement.outerHeight() + 'px')
                     .css('border-radius', boundElement.css('border-radius'))
                     .css('border', boundElement.css('border'));
                boundElement.addClass('with-add-on')
                            .before(addOn)
                            .css('padding-left', (parseInt(boundElement.css('padding-right')) + boundElement.outerHeight()) + 'px')
                            .attr('readonly',true);
            }
            ...
            offsetElement.on("click.spectrum", function (e) {
                if (!disabled) {
                    toggle();
                }
            ...
            if (opts.type == "text" || opts.type == "component") {
                ...
                if (color && colorizeElement) {
                    ...
                    if(color.toRgbString() == 'rgb(255, 255, 255)') {
                        colorizeElement.css('box-shadow','inset 0 0 0 1px #ced4da');
                    } else {
                        colorizeElement.css('box-shadow','');
                    }
                } else {
