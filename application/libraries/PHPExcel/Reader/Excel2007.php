        ...
        foreach ($rels->Relationship as $rel) {
            switch ($rel["Type"]) {
                ...
                case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument":
                    ...
                    $__arr = isset($xpath['Target']) ? $xpath['Target'] : 1;
                    $xmlStrings = simplexml_load_string($this->securityScan($this->getFromZipArchive($zip, "$dir/$__arr")), 'SimpleXMLElement', PHPExcel_Settings::getLibXmlLoaderOptions());
