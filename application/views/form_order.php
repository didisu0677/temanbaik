...
<body class="bg-grey p-0">
	<div class="container">
        <div class="row justify-content-center">
			<div class="col col-md-10 col-lg-7 mt-4 mb-4">
				<div class="card mb-4">
                    ...
                    <div class="card-body p-4">
                        <form method="post" action="<?php echo base_url('checkout'); ?>" id="formCheckout">
                            ...
                            <div class="form-group row mb-4 progresive">
                                ...
                                <div class="col-12">
                                    <textarea name="alamat" id="alamat" class="form-control" data-validation="required" rows="5" placeholder="Contoh : Jl. KH Ahmad Sanusi, No.15, RT.01 RW.01" aria-label="Alamat Lengkap"></textarea>
                                </div>
                            </div>
