<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/plugins/spectrum/spectrum.min.css'); ?>">
				...
				<div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="email_perusahaan"><?php echo lang('email_perusahaan'); ?></label>
								<div class="col-sm-9">
									<input type="text" name="email_perusahaan" id="email_perusahaan" class="form-control" autocomplete="off" data-validation="email" value="<?php echo setting('email_perusahaan'); ?>">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="image-upload small">
										<div class="image-content">
											<img src="<?php echo base_url(dir_upload('setting').setting('favicon')); ?>" alt="Favicon" data-action="<?php echo base_url('upload/image/256/256'); ?>">
											<input type="hidden" name="favicon" data-validation="image">
										</div>
										<div class="image-description">256 x 256 (px)</div>
									</div>
								</div>
							</div>
							<div class="form-group row">
